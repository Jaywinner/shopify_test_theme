...
var ProductZoom = function () {
  ...
  createClass(ProductZoom, [{
    key: 'unload',
    value: function unload() {
      this.imageZoom.forEach(function (image) {
        image.unload();
      });
      ...
      if (inObject && slideExists) {
        ...
        $newSlide.on('pixelzoom:touch', function () {
          ...
          if (!layout.isBreakpoint('XS') && (imageWidth / $newSlide.width() >= 2 || imageHeight / $newSlide.height() >= 2)) {
            _this._toggleClass(jquery$1('body'), 'pixelzoom--active');
          }
        ...
        $newSlide.on('pixelzoom:release', function () {
          _this._toggleClass(jquery$1('body'), 'pixelzoom--active', true);
          _this.touched = false;
        });
      }
    }
    ...
    value: function _onOpen() {
      ...
      setTimeout(function () {
        _this3.zoomOverlay = new Pixelzoom(document.querySelector('[data-modal-content]'), {
          imageSource: $newSlide[0].dataset.image,
          naturalPan: true,
          dragPan: true,
          initialZoom: _this3.settings.image_zoom_level === 'min' ? 1 : 9999,
          maxZoom: 9999,
          zoomSensitivity: 10,
          zoomSteps: 9999,
        ...
        jquery$1('[data-modal-content]').on('pixelzoom:touch', function () {
          _this3._toggleClass(jquery$1('body'), 'pixelzoom--active');
        });

        jquery$1('[data-modal-content]').on('pixelzoom:release', function () {
          _this3._toggleClass(jquery$1('body'), 'pixelzoom--active', true);
        });
      }, 500);
    }
  }, {
...
//# sourceMappingURL=empire.js.map?1533673702999
